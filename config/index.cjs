...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxbfe9a4517f64f392',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5d693677714f5fa07fd8f44392a43b4a',
  ...
  USERS: [
    {
      ...
      id: 'ouxQ26vaAvOfP3RJI6D4Gd_DfkEI',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'pwF7KFwZX1rFaJMGBmZoWvfHFbXslzB-DDvj2oNu_J0',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
